...
public class C05_Arrays_Equals {
    public static void main(String[] args) {
        ...
        System.out.println("Arr1 arr2'ye eşit mi? " + Arrays.equals(arr1, arr2));//false
        ...
        //Arrayi Strinde convert(çevirme)
        String str=Arrays.toString(arr1);
        System.out.println("str = " + str);//str = [2, 5, 13, 27, 33, 38, 49, 58, 65]
        System.out.println(str.substring(5));//, 13, 27, 33, 38, 49, 58, 65]
