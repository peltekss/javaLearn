...
*/
        //List tanimlama ve deger atam
        ArrayList<Integer> sayiList=new ArrayList<>();//Inter type'nda bos bir list tanimlandi
        //1.yol add() meth.
        ...
        sayiList.add(35);
        sayiList.add(10);
        sayiList.add(10);//aynieleman birden cok defa liste eklenebilir
        ...
        System.out.println("ulkeList = " + ulkeList);//[Alamanya, Isvec, Danimarka, Belcika, Hollanda]
