...
public class C05_PassByValue {
    public static void main(String[] args) {
        ...
        */
        double etiketFiyatı=100;//Primitive main scope initial(ilk değer atama yapıldı) variable
        double indirimOranı =0.1;//Primitive main scope initial(ilk değer atama yapıldı) variable
