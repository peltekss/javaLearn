...
public class StringClassMethods {
    public static void main(String[] args) {
        ...
        String myStr1 = "Hello";
        String myStr2 = "Hello";
        System.out.println(((String) myStr1).

                compareTo(myStr2)); // Returns 0 because they are equal
        ...
        String myStr3 = "Hello";
        System.out.println(((String) myStr3).
        ...
        String myStr5 = "Hello";
        System.out.println(((String) myStr5).

                contentEquals("Hello"));  // true
        System.out.println(((String) myStr5).

                contentEquals("e"));      // false
        System.out.println(((String) myStr5).

                contentEquals("Hi"));     // false

        // endsWith(): Bir dizenin belirtilen karakter (ler) ile bitip bitmediğini kontrol eder. boolean döndürür.
        String myStr6 = "Hello";
        System.out.println(((String) myStr6).
        ...
        System.out.println(((String) myStr10).

                equalsIgnoreCase(myStr11)); // true
        System.out.println(((String) myStr10).

                equalsIgnoreCase(myStr12)); // false
        ...
        System.out.println(((String) myStr14).
