...
public class C01_EncapsulationRunner {
    public static void main(String[] args) {
		 ...
		 */
        C02_Encapsulation obj1=new C02_Encapsulation();//psiz const call edilerek obj create edildi
        obj1.ad="Halit Bey";
        obj1.soyad="Guzel";
        //System.out.println("obj1.idVer() = " + obj1.idVer());
        obj1.ad="Savfet Bey";//encapsule edilmeyen variable obj ile call edilip update edilir
        ...
        System.out.println("obj1.getEmail() = " + obj1.getEmail());//falanFilan@gmail.com
    }
}
