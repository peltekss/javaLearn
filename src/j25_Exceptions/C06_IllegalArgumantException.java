...
public class C06_IllegalArgumantException {
    public static void main(String[] args) {
        ...
        try {
            if (yas < 18) {
                ...
                hata();//throw exc meth call edldi.
                //throw keyword ile data typ'da exc obj tanımlanıp hata fırlatması yapıldı.
    ...
    private static void hata() {
        throw new IllegalArgumentException("Bu yaşta ehliyet alamazsin baska kapiya ");
    }
}
